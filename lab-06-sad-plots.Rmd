...
***Some ways to improve the chart would be to get ride of the pie charts on the right, and then organize the chart on the left so it is clearer to see and read. Maybe choose a differnt style of chart so you can see the data better, and change the colors and opacity.***
